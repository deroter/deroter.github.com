...
<table>
  <tr>
    <th>Framework</th>
    <th>Preprocessor</th>
    <th>Templates</th><br>  </tr><tr>
    <td><a href="http://jacobrask.github.com/styledocco/">styledocco</a></td>
    <td>Less, SASS</td>
    <td>Default template provided by styledocco is used</td><br>  </tr><tr>
    <td><a href="https://github.com/hughsk/kss-node">kss-node</a></td>
    <td>Less</td>
    <td>Template can be configured to include files post compile and custom templates can be used</td><br>  </tr>
</table>

<h2 id="getting-started">Getting Started</h2>
<p><em>If you haven&#39;t used <a href="http://gruntjs.com/">grunt</a> before, be sure to check out the <a href="https://github.com/gruntjs/grunt/blob/devel/docs/getting_started.md">Getting Started</a> guide.</em></p>
<p>From the same directory as your project&#39;s <a href="https://github.com/gruntjs/grunt/blob/devel/docs/getting_started.md">Gruntfile</a> and <a href="https://npmjs.org/doc/json.html">package.json</a>, install this plugin with the following command:</p>
<pre><code class="lang-bash">npm install grunt-styleguide --save-dev</code></pre>
<p>Once that&#39;s done, add this line to your project&#39;s Gruntfile:</p>
<pre><code class="lang-js">grunt.loadNpmTasks(&#39;grunt-styleguide&#39;);</code></pre>
<p>If the plugin has been installed correctly, running <code>grunt --help</code> at the command line should list the newly-installed plugin&#39;s task or tasks. In addition, the plugin should be listed in package.json as a <code>devDependency</code>, which ensures that it will be installed whenever the <code>npm install</code> command is run.</p>
<h2 id="the-styleguide-task">The &quot;styleguide&quot; task</h2>
<h3 id="overview">Overview</h3>
<p>In your project&#39;s Gruntfile, add a section named <code>styleguide</code> to the data object passed into <code>grunt.initConfig()</code>.</p>
<textarea class="preview-code" spellcheck="false">grunt.initConfig({
...
})</textarea><p>An example configuration can be view <a href="https://gist.github.com/3932026">here</a></p>
<h4 id="options">Options</h4>
<p>By default <strong>grunt-styleguide</strong> will attempt to rationalize options for each of the styleguide frameworks supported depending upon the features available to the framework in use.</p>
...
<table>
  <tr>
    ...
    <th>Type</th>
    <th>Default</th>
    <th>Required</th><br>    <th>Description</th>
  </tr><tr>
    <td>framework</td>
    <td>String, object, function (*)</td>
    <td>styledocco</td>
    <td>No</td>
    <td>Details about the styleguide framework</td><br>  </tr><tr>
    <td>name</td>
    <td>String</td>
    <td>undefined</td><br>    <td>No</td>
    <td>Title of the styleguide</td><br>  </tr><tr>
    <td>template</td>
    <td>Object</td>
    <td>Template bundled with framework</td><br>    <td>No</td>
    <td>Details of the templetes to use for rendering if supported</td><br>  </tr><tr>
    <td>files</td>
    <td>Object, String, Array</td>
    <td>undefined</td><br>    <td>Yes</td>
    <td>Details of the templetes to use for rendering if supported</td><br>  </tr>
</table>

<blockquote>
<p>* See <a href="">extending grunt-styleguide</a></p>
</blockquote>
<h4 id="framework-options">Framework Options</h4>
<p>Should you wish to pass additional options which are supported by a framework then these can be passed as an options as part of the framework object. </p>
<textarea class="preview-code" spellcheck="false">styleguide: {
...
}</textarea><h4 id="template-options">Template Options</h4>
<p>Depending upon the framework, it may be possible to also pass templates to use for rending a styleguide.</p>
<textarea class="preview-code" spellcheck="false">styleguide: {
  ...
  <tr>
    ...
    <td>String</td>
    <td>No</td>
    <td>Location of the template to use</td><br>  </tr><tr>
    <td>include</td>
    <td>String, Array</td>
    <td>No</td>
    <td>Title of the styleguide</td><br>  </tr>
</table>

<p>Depending upon the framework you wish to use example templates can be found in:</p>
<p><code>node_modules/grunt-styleguide/templates/&lt;framwork.name&gt;/templates</code></p>
<p>A generic template is provide also:</p>
<p><code>node_modules/grunt-styleguide/templates/generic</code></p>
<p>Copy these to a location which is part of your project and modify your gruntfile to support your individual requirements.</p>
<h4 id="css-preprocessors">CSS Preprocessors</h4>
<p>By default <strong>grunt-styleguide</strong> will determine the CSS preprocessor to use by evaluating the selected source files. This value will be passed as an option to framework and if supported will be used by it.</p>
<h3 id="usage-examples">Usage Examples</h3>
<h4 id="default-options">Default Options</h4>
<p>In this example a styleguide will be generated using the default generator, <code>styledocco</code>. Guides will be created for css/scss located within the <strong>core</strong> and <strong>plugins</strong> directory and output them to the appropriate destination specified.</p>
<textarea class="preview-code" spellcheck="false">grunt.initConfig({
...
});</textarea><h2 id="contributing">Contributing</h2>
...
<h3 id="024">0.2.4</h3>
<ul>
<li>Pass local less path to styledocco</li>
</ul>
<h3 id="023">0.2.3</h3>
<ul>
<li>Styleguide nolonger uses custom node-kss fork (includes nolonger supported for KSS beware)</li>
</ul>
<h3 id="022">0.2.2</h3>
<ul>
<li>Grunt 0.4.0 support (~0.3.0 no longer supported)</li>
</ul>
<h3 id="021">0.2.1</h3>
<ul>
<li>Minor bug fix</li>
